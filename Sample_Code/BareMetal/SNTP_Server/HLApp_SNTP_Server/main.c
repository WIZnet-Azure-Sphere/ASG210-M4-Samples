...
static const char rtAppComponentId[] = "bdb8c28f-0988-4b1a-94b1-17de09347526";
...
/// <summary>
///     Send time data to RT application socket.
/// </summary>
static void SendTimeData(void)
{
    char timeBuf[64];
...
int main(void)
{
    Log_Debug("High-level application for SNTP server sample.\n");
    Log_Debug("Sends time data to a real-time capable application.\n");
