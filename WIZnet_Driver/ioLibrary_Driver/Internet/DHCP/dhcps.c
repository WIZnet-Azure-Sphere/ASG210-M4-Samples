...
#ifdef debug_released_ip
  printf("DHCP_RELEASED_IP: %d:%d:%d:%d\r\n", dhcp_message_repository->yiaddr[0], dhcp_message_repository->yiaddr[1], 
      dhcp_message_repository->yiaddr[2], dhcp_message_repository->yiaddr[3]);
#endif
}
